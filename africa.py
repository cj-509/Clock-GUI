...
class Africa:
    ...
    def Bissau():
        now =datetime.datetime.now(tz=pytz.timezone('Africa/Bissau'))
        current_time = now.strftime("%I:%M:%S %p")
        return current_time
    ...
    def Libreville():
        now =datetime.datetime.now(tz=pytz.timezone('Africa/Libreville'))
        current_time = now.strftime("%I:%M:%S %p")
        return current_time
    
    def Douala():
        now =datetime.datetime.now(tz=pytz.timezone('Africa/Douala'))
        current_time = now.strftime("%I:%M:%S %p")
        return current_time
    
    def Khartoum():
        now =datetime.datetime.now(tz=pytz.timezone('Africa/Khartoum'))
        current_time = now.strftime("%I:%M:%S %p")
        return current_time
    
    def Kinshasa():
        now =datetime.datetime.now(tz=pytz.timezone('Africa/Kinshasa'))
        current_time = now.strftime("%I:%M:%S %p")
        return current_time
